    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row">
            <div class="mx-auto w-50">
                <form action="/admin/get-user-classes" method="post">
            ...
            @if($data == null)
                <form action="/admin/assign-classes" method="post">
                    <div class="row">
                        <div class="mx-auto w-50">
                            <div class="design input-group-sm py-2">

                                <div class="row py-2">
                                    @foreach($klass as $list)
                                        <div class="col-4 input-group-sm ">
                                            <input type="checkbox" name="class_id[]" value="{{$list->id}}"
                                                   class="mx-3 py-2">
                                            <span>{{$list->name}}</span>
                                        </div>
                                    @endforeach
                            ...
                            <div class="design input-group-sm py-2">
                                ...
                                <div class="row py-2">
                                    @foreach($klass as $list)
                                        <div class="col-4 input-group-sm ">
                                            <input type="checkbox" name="class_id[]" value="{{$list->id}}"
                                                   class="mx-3 py-2" @foreach($classRoles as $roles) @if($list->id ==$roles) checked @endif @endforeach> <span>{{$list->name}}</span>
                                        </div>
                                    @endforeach
